...
f3 = ROOT.TFile("hp_CMSSW14_usingL1SLHC7_PU140_alctGhostCancellationBxDepth_eff.root")
...
f4 = ROOT.TFile("hp_CMSSW14_usingL1SLHC7_PU140_alctGhostCancellationSideQuality_eff.root")
...
f5 = ROOT.TFile("hp_CMSSW14_usingL1SLHC7_PU140_alctNarrowMaskForR1_eff.root")
...
f6 = ROOT.TFile("hp_CMSSW14_usingL1SLHC7_PU140_alctPretrigDeadtime_eff.root")
...
b1.GetYaxis().SetRangeUser(0.8,1.02)
...
legend = ROOT.TLegend(0.25,0.13,0.77,0.48)
legend.SetFillColor(ROOT.kWhite)
legend.SetHeader("PU140 and 10<pT<50")
legend.AddEntry(e2,"TMB Baseline 1","l")
legend.AddEntry(e3,"alctGhostCancellationBxDepth: 4BX to 1BX","p")
legend.AddEntry(e4,"alctGhostCancellationSideQuality: False to True","p")
legend.AddEntry(e5,"alctNarrowMaskForR1: False to True","p")
legend.AddEntry(e6,"alctPretrigDeadtime: 4BX to 0BX","p")
legend.AddEntry(e7,"TMB Baseline 2","l")
legend.Draw("same")

c1.SaveAs("ALCT_reco_eff_PU140.pdf")
c1.SaveAs("ALCT_reco_eff_PU140.png")
