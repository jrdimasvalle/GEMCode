...
h0 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d0, etareb, ROOT.kBlack, 1, 2, ROOT.kRed, 4, topTitle,xTitle,yTitle,xrange,yrange)
h1 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d1, etareb, ROOT.kRed+1, 1, 2, ROOT.kRed, 4, topTitle,xTitle,yTitle,xrange,yrange)
h2 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d2, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 4, topTitle,xTitle,yTitle,xrange,yrange)
h3 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d3, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 21, topTitle,xTitle,yTitle,xrange,yrange)
h4 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d4, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 22, topTitle,xTitle,yTitle,xrange,yrange)
h5 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d5, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 23, topTitle,xTitle,yTitle,xrange,yrange)
h6 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d6, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 25, topTitle,xTitle,yTitle,xrange,yrange)
h7 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d7, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 26, topTitle,xTitle,yTitle,xrange,yrange)
h8 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d8, etareb, ROOT.kGreen+2, 1, 2, ROOT.kGreen+2, 20, topTitle,xTitle,yTitle,xrange,yrange)
h9 = setEffHisto2("h_eta_me11_after_lct_okAlctClct","h_eta_me11_initial",d9, etareb, ROOT.kBlue+1, 1, 2, ROOT.kRed, 4, topTitle,xTitle,yTitle,xrange,yrange)
