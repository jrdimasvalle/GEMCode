...
h1 = setEffHisto2("h_eta_me1_after_lct_okAlctClct","h_eta_me1_initial",d9, etareb, ROOT.kRed, 1, 2, ROOT.kBlue, 4, topTitle,xTitle,yTitle,xrange,yrange)
ha = setEffHisto3("h_eta_me1_after_lct_okAlctClct","h_eta_me1_initial",d9, etareb, ROOT.kBlue, 1, 2, ROOT.kRed, 4, topTitle,xTitle,yTitle,xrange,yrange)
...
legend.SetHeader("Histogram Based")
legend.AddEntry(h1,"TMB SLHC: Numerator","l")
legend.AddEntry(ha,"TMB SLHC: Denominator","l")

legend.Draw("same")


c1.SaveAs("Den_Num_hist_SLHC.png")
