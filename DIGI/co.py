...
# with command line options: SingleMuPt100_cfi -s GEN,SIM,DIGI:pdigi_valid --conditions auto:upgradePLS3 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023Muon --magField 38T_PostLS1 --datatier GEN-SIM-DIGI --geometry Extended2023Muon --eventcontent FEVTDEBUGHLT -n 1000 --no_exec --fileout out_digi.root
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('out_digi_co.root'),
