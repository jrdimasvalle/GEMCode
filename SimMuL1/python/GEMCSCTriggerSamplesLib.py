...
eosfiles['PU140_TMB_Baseline_1'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/TMB_Baseline_1/']

#ALCT improvements
eosfiles['PU140_alctGhostCancellationBxDepth'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/alctGhostCancellationBxDepth/']
eosfiles['PU140_alctGhostCancellationSideQuality'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/alctGhostCancellationSideQuality/']
eosfiles['PU140_alctNarrowMaskForR1'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/alctNarrowMaskForR1/']
eosfiles['PU140_alctPretrigDeadtime'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/alctPretrigDeadtime/']

#CLCT improvements 
eosfiles['PU140_useDeadTimeZoning'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/alctNarrowMaskForR1/']
eosfiles['PU140_useDynamicStateMachineZone'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/useDynamicStateMachineZone/']
eosfiles['PU140_clctPidThreshPretrig'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/clctPidThreshPretrig/']
eosfiles['PU140_clctMinSeparation'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/clctMinSeparation/']


#TMB Baseline 2 = ALCT + CLCT improvments 
eosfiles['PU140_TMB_Baseline_2'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/TMB_Baseline_2/']


#TMB improvments 
eosfiles['PU140_matchTrigWindowSize'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/matchTrigWindowSize/']
eosfiles['PU140_alctUseCorrectedBx'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/alctUseCorrectedBx/']
eosfiles['PU140_clctUseCorrectedBx'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/clctUseCorrectedBx/']
eosfiles['PU140_clctToAlct'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/clctToAlct/']
eosfiles['PU140_tmbDropUsedClcts_matchEarliestClctME11Only'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/tmbDropUsedClcts_matchEarliestClctME11Only/']
eosfiles['PU140_tmbCrossBxAlgorithm'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/tmbCrossBxAlgorithm/']
eosfiles['PU140_tmbReadoutEarliest2'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/tmbReadoutEarliest2/']


#SLHC = Actual configuration for CSC4 with CLCT, ALCT and TMB Improvments 
eosfiles['PU140_SLHC'] = ['/eos/uscms/store/user/jdimasva/CSC_Up_N/PU140_v2/SLHC/']
