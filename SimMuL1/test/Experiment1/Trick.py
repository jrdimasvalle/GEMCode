...
asd = process.simCscTriggerPrimitiveDigis.me11tmbSLHCGEM


asd.tmbDropUsedClcts = cms.bool(False)
asd.debugGEMDphi = cms.bool(False)
asd.doLCTGhostBustingWithGEMs = cms.bool(False)
asd.buildLCTfromALCTandGEM_ME1a = cms.bool(False)
asd.buildLCTfromALCTandGEM_ME1b = cms.bool(False)
asd.gemMatchDeltaPhiEven = cms.double(1)
asd.gemMatchMaxEta = cms.double(2.15)
asd.debugLUTs = cms.bool(False)
asd.maxDeltaBXCoPadOdd = cms.int32(0)
asd.promoteALCTGEMpattern = cms.bool(False)
asd.matchEarliestAlctME11Only = cms.bool(False)
asd.maxDeltaPadPadEven = cms.int32(2)
asd.matchTrigWindowSize = cms.uint32(3)
asd.maxME11LCTs = cms.uint32(2)
asd.matchTrigEnable = cms.uint32(1)
asd.clctToAlct = cms.bool(False)
asd.maxDeltaBXPadOdd = cms.int32(1)
asd.useOldLCTDataFormatCLCTGEM = cms.bool(False)
asd.tmbDropUsedAlcts = cms.bool(False)
asd.useOldLCTDataFormatALCTGEM = cms.bool(False)
asd.gemMatchMinEta = cms.double(1.55)
asd.tmbL1aWindowSize = cms.uint32(7)
asd.firstTwoLCTsInChamber = cms.bool(True)
asd.buildLCTfromCLCTandGEM_ME1b = cms.bool(False)
asd.clctTrigEnable = cms.uint32(0)
asd.buildLCTfromCLCTandGEM_ME1a = cms.bool(False)
asd.gemClearNomatchLCTs = cms.bool(False)
asd.correctLCTtimingWithGEM = cms.bool(False)
asd.alctTrigEnable = cms.uint32(0)
asd.maxDeltaPadCoPadOdd = cms.int32(3)
asd.maxDeltaBXPadEven = cms.int32(1)
asd.maxDeltaBXInCoPad = cms.int32(1)
asd.dropLowQualityCLCTsNoGEMs_ME1a = cms.bool(False)
asd.tmbEarlyTbins = cms.int32(4)
asd.promoteCLCTGEMquality_ME1a = cms.bool(False)
asd.promoteCLCTGEMquality_ME1b = cms.bool(False)
asd.tmbCrossBxAlgorithm = cms.uint32(2)
asd.dropLowQualityALCTsNoGEMs_ME1b = cms.bool(False)
asd.gemMatchDeltaEta = cms.double(0.08)
asd.dropLowQualityALCTsNoGEMs_ME1a = cms.bool(False)
asd.maxDeltaPadPadOdd = cms.int32(3)
asd.verbosity = cms.int32(0)
asd.promoteALCTGEMquality = cms.bool(False)
asd.matchEarliestClctME11Only = cms.bool(False)
asd.tmbReadoutEarliest2 = cms.bool(False)
asd.maxDeltaPadCoPadEven = cms.int32(2)
asd.maxDeltaPadInCoPad = cms.int32(1)
asd.doGemMatching = cms.bool(False)
asd.gemMatchDeltaPhiOdd = cms.double(1)
asd.dropLowQualityCLCTsNoGEMs_ME1b = cms.bool(False)
asd.gemMatchDeltaBX = cms.int32(1)
asd.mpcBlockMe1a = cms.uint32(0)
